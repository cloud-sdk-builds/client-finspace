...
[`@aws-sdk/client-finspace`](https://www.npmjs.com/package/@aws-sdk/client-finspace/v/3.1127.0).
...
- @aws-sdk/client-finspace v3.1127.0 - [https://cloud-sdk-builds.github.io/?sdk=client-finspace&version=3.1127.0](https://cloud-sdk-builds.github.io/?sdk=client-finspace&version=3.1127.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace@3.1127.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UjYp5tHGk45NTx+bedDByTyGe2A2Hyo5FmzYBnbMv+CMFS5tSLIKKruxn08/JkpH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace@3.1127.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace@3.1127.0/index.min.mjs": "sha384-UjYp5tHGk45NTx+bedDByTyGe2A2Hyo5FmzYBnbMv+CMFS5tSLIKKruxn08/JkpH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace/blob/refs/tags/3.1127.0/LICENSE
```
